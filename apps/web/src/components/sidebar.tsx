...
const academyNavItems = [
  ...
  { href: "/dashboard/levels", label: "Levels", icon: Layers },
      ...
      >
        ...
        <div className="border-b border-zinc-200/40 p-2 dark:border-zinc-700/40">
          {loading ? (
            ...
            >
              <div className="h-8 w-8 shrink-0 animate-pulse rounded-lg bg-zinc-200 dark:bg-zinc-700" />
              {!collapsed && (
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="flex w-full items-center justify-center rounded-xl border-2 border-dashed border-zinc-200 py-3 text-zinc-500 transition-colors hover:border-violet-300 hover:text-violet-600 dark:border-zinc-700 dark:hover:border-violet-600 dark:hover:text-violet-400"
                  >
        ...
        <nav className="flex-1 space-y-0.5 overflow-y-auto p-2">
          ...
          {selectedAcademy && (
            <>
              {!collapsed && (
                <div className="px-3 pb-0.5 pt-3 text-[10px] font-semibold uppercase tracking-widest text-zinc-400">
                  Academy
                </div>
              )}
